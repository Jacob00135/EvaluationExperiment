...
class TableData:
    def __init__(self):
        ...
        self.imageDir = '/root/workspace/lxs/ADNI/npy/'  #'../data/datasets/ADNI3/'
    ...
    def get_filenames_and_IDs(self, path):
        ...
        # fileNameLists = [fullpath.split('/')[-1] for fullpath in fullpathList]
        # # fileNameList = [a for a in fileNameList if a[11]=='6']
        # fileNameList = []
        # for a in fileNameLists:
        #     if len(a) >= 16:
        #         if a[11] == '6':
