...
def plot_CNN_shap(filenames, out_folder):
    ...
    seg = nib.load('/home/huangyunyou/ncomms2022-main/MRI_process/MNI_segmentation_template.nii.gz').get_data()[6:-6, 6:-6, 6:-6]
...
def region_ADD_shap_sum(tb_log_dir):
    VD, FTD, LBD = [], [], []
    with open('/home/huangyunyou/ncomms2022-main/lookupcsv/dataset_table/NACC_ALL/NACC.csv', 'r') as csv_file:
    ...
    shap_dir = '/home/huangyunyou/ncomms2022-main/data_2/sq/shap_mid/'
    ...
    for i in range(5):
        with open(tb_log_dir + 'cross{}/'.format(i) + 'test_eval.csv', 'r') as csv_file:
            reader = csv.DictReader(csv_file)
            for row in reader:
                seg_dir = '/home/huangyunyou/ncomms2022-main/data_2/NACC_ALL/seg/' + row['filename'].replace('.npy', '.nii')
    ...
    np.save('/home/huangyunyou/ncomms2022-main/shap/regional95_avgScore_nADD.npy', array_nADD)
    np.save('/home/huangyunyou/ncomms2022-main/shap/regional95_avgScore_VD.npy', array_VD)
    np.save('/home/huangyunyou/ncomms2022-main/shap/regional95_avgScore_FTD.npy', array_FTD)
    np.save('/home/huangyunyou/ncomms2022-main/shap/regional95_avgScore_LBD.npy', array_LBD)
...
def region_COG_shap_sum(tb_log_dir):
    ...
    np.save('/home/huangyunyou/ncomms2022-main/shap/regional95_avgScore_NC.npy', array_NC)
    np.save('/home/huangyunyou/ncomms2022-main/shap/regional95_avgScore_MCI.npy', array_MCI)
    np.save('/home/huangyunyou/ncomms2022-main/shap/regional95_avgScore_DE.npy', array_DE)
...
if __name__ == "__main__":
    ...
    region_ADD_shap_sum('/home/huangyunyou/ncomms2022-main/tb_log/CNN_baseline_new_')
